...
1. Lock **host wire** in the spec (§4) using **`usb64`** / X7 traces; **edlink** is a different framing on PRO/CORE — see [`multi64-ed64-link`](../../crates/multi64-ed64-link), [`ed64-sd-usb-host.md`](../../docs/spec/ed64-sd-usb-host.md).
