 ...
 * styles.css. Runs before first paint so the window never shows a flash of the wrong theme when the
...
(() => {
  ...
  const THEMES = ["dark", "light", "system", "contrast"];
  const MOTION = ["system", "reduced"];
