...
3. **VCP vs D2XX.** UNFLoader uses D2XX and purges the FTDI queues directly. Whether a `serialport` VCP handle gives equivalent behavior under load — particularly for the purge in §4.4 — is unverified.
